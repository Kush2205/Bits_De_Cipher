...
function Rules() {
    ...
    return (
        <div style={{ fontFamily: pixelify.style.fontFamily }} className='h-[110vh] bg-neutral-800  justify-center items-center w-full'>
            ...
            <div className='flex flex-col  justify-center items-center ml-4 space-y-4 w-full mt-9 text-3xl'>
                ...
                <h1 className=' text-white font-extralight'>4. We regret any physical or emotional trauma you may suffer during this content. 😔</h1>
             </div>
            </div>
        </div>
    )
