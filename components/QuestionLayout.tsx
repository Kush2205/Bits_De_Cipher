...
const QuestionLayout: React.FC<QuestionProps> = ({ imageUrl, questionId ,points }) => {
  ...
  const handleHint = (hintNumber: number) => {
    console.log(`Hint ${hintNumber} requested for Question ${questionId}`);
  };
  ...
  return (
    <div className="p-5 w-[70vw] bg-neutral-800 h-[90%]">
      ...
      <div style={{fontFamily : pixelifySans.style.fontFamily}} className="flex gap-5 my-5 w-full justify-center gap-x-10">
        <button
